            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                ...
                <h3 className="mt-0 mb-12">
                    ArcheAge Unchained/ArcheRage
                  </h3>
                <p className="m-0">
                ArcheAge is not about following a defined path.
It's about creating your own path by choosing what matters the most to you.
                  </p>
              </div>
              <div className={
                classNames(
                ...
                <Image
                  src={require('./../../assets/images/archeage_pvp.jpg')}
            ...
            <div className="split-item">
              ...
              <div className={
                ...
                data-reveal-container=".split-item">
                <Image
                  src={require('./../../assets/images/ow2.jpg')}
            ...
            <div className="split-item">
              ...
              <div className={
                ...
                data-reveal-container=".split-item">
                <Image
                  src={require('./../../assets/images/apexlgends.jpg')}
